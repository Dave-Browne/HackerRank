...
if __name__ == "__main__": 
    ...
    if inp != 'INIT':
        ...
        subs = [[0, 4], [0, 7]]
        ships_start = [[1, 9], [8, 3], [4, 9], [1, 0], [1, 2]]
        ships_end   = [[2, 9], [9, 3], [6, 9], [4, 0], [1, 6]]
        for i in range(len(subs)):
            print(f'{subs[i][0]} {subs[i][1]}')

        for i in range(len(ships_start)):
            print(f'{ships_start[i][0]} {ships_start[i][1]}:{ships_end[i][0]} {ships_end[i][1]}')
